...
public class HexEncoder implements Encoder {
    ...
    public int decode(byte[] var1, int var2, int var3, OutputStream var4) throws IOException {
        ...
        int var8;
        for(var8 = var2 + var3; var8 > var2 && this.ignore((char)var1[var8 - 1]); --var8) {
        }

        for(int var9 = var2; var9 < var8; ++var7) {
            while(var9 < var8 && this.ignore((char)var1[var9])) {
                ++var9;
            }

            byte var5;
            for(var5 = this.decodingTable[var1[var9++]]; var9 < var8 && this.ignore((char)var1[var9]); ++var9) {
            }
    ...
    public int decode(String var1, OutputStream var2) throws IOException {
        ...
        int var6;
        for(var6 = var1.length(); var6 > 0 && this.ignore(var1.charAt(var6 - 1)); --var6) {
        }

        for(int var7 = 0; var7 < var6; ++var5) {
            while(var7 < var6 && this.ignore(var1.charAt(var7))) {
                ++var7;
            }

            byte var3;
            for(var3 = this.decodingTable[var1.charAt(var7++)]; var7 < var6 && this.ignore(var1.charAt(var7)); ++var7) {
            }
